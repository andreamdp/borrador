...
urlpatterns = patterns('',
 ...
 #   url('(?P<residenciaaut_id>\d+)/ficha/$', libro_pdf),
   ...
   # (r'(?P<residenciaaut_id>\d+)/residente/$', residente_list),
    ...
    (r'(?P<residenciaaut_id>\d+)/jefeResidente/$', jefeResidente_add),
    (r'^(?P<residenciaaut_id>\d+)/lista/residente_edit/(?P<residente_id>\d+)/$', residente_edit),
